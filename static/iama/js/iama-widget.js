// The whole of the Angular app for the widget, right here.
// TODO: Come up with a sane modularity of the app logic itself.
...
function(angular) {
    ...
    return angular.module('iama-widget', [])
    ...
    .controller('IamaCtrl', function($scope, $http, $log, $backend_url) {
        ...
        // Photos on display.
        // :: (or/c { full_url : String, small_url : String, date : Date }
        //          undefined)
        $scope.current = undefined;
        $scope.next = undefined;
        $scope.prev = undefined;
        // The full timeline.
        // :: [{ full_url : String, small_url : String, date : Date }]
